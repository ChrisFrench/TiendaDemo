...
class plgSystemJFirePHP extends JPlugin
{
	...
	function onAfterInitialise()
	{
		...
		if (intval($phpver[0])==4) {
			require_once(JPATH_PLUGINS.DS.'system'.DS.'jfirephp'.DS.'jfirephp'.DS.'firephpcore'.DS.'fb.php4');
		} else {
			require_once(JPATH_PLUGINS.DS.'system'.DS.'jfirephp'.DS.'jfirephp'.DS.'firephpcore'.DS.'fb.php');
		}
